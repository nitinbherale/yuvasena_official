...
<body>
  ...
  <!-- Start Site Header -->
    ...
    <section id="page" class="page-section">
        ...
        <div class="contact-info-area mtb-20">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="single_contact_info">
                            ...
                            <div class="info">
                                <p>N. C. Kelkar Road , Bhawani Sankar, Dadar Mumbai, Maharashtra 400028</p>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="single_contact_info">
                            ...
                            <div class="info">
                                <p>Email :<a href="mailto:info@yourwebsite.com">info@yuvasena.com</a> </p>
                                <p><a href="#">www.yuvasena.co.in</a></p>
                            </div>
                        </div><!-- End single contact info -->
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <!--<div id="gmaps"></div>-->
                        <div id="google_map">
                        	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.8881423397142!2d72.8383065141456!3d19.024650058530028!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7ced00569b3e5%3A0x5dd5dd83b6ee3b50!2sShiv+Sena+Bhavan%2C+N.+C.+Kelkar+Road%2C+Bhawani+Sankar%2C+Dadar%2C+Mumbai%2C+Maharashtra+400028!5e0!3m2!1sen!2sin!4v1530170765795" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="newsletter_area mtb-100">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="newsletter">
                            <div class="newsletter_content">
                                <div class="section_title">
                                    <h2 class="title__heading text-capitalize">Subscribe Our Newsletter</h2>
                            ...
                            <form class="subcribe-form" action="#">
                                <div class="input">
                                    ...
                                    <input type="text" placeholder="Enter your emaill address">
                                    <button type="submit" class="btn btn-default btn-subcribe">Submit Now</button>
                                </div>
                            </form><!--/.subcribe-form-->
                        </div>
                    </div>
