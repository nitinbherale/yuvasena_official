    ...
    <footer id="footer" class="footer">
        ...
        <div class="footer-widgets-area pt-40 pb-20">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="single_contact_info">
                            ...
                            <div class="info">
                                <p>7N. C. Kelkar Road, Bhawani Sankar, Dadar, Mumbai, Maharashtra 400028</p>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="single_contact_info">
                            ...
                            <div class="info">
                                <p>Official Fax: 123 456 789</p>
                                <p>Official Phone: 9876 543 210</p>
                            </div>
                        </div><!-- End single contact info -->
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-7 col-xs-12">
                        <div class="copyright">
                            <p>&copy; 2018 Copyright <a href="#">Yuvasena</a> All rights reserved.</p>
                        </div><!-- Copyright Text -->
                    </div>
