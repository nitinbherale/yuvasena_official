                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="section_title text-center">
                            <h2 class="title__heading text-capitalize">- Party Ideology</h2>
                            <p>Our first priority- development</p>
                        </div><!--/.section_title-->
                    </div>
                </div><!--/.row-->
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="career_thumbs">
                            <div class="thumb image_effect"> 
                                <img src="images/career/3.jpg" alt="thumb">
                            </div>
                            <div class="thumb image_effect hidden-xs hidden-sm"> 
                                <img src="images/career/4.jpg" alt="thumb">
                            </div>
                        </div><!--/.career_thumbs-->
                    </div>
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        <div class="career_info">
                            ...
                            <div class="career_block_list">
                                ...
                                <div class="single_career">
                                    <div class="info">
                                        <h3>- Conflict Against Injustice</h3>
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                                    </div>
                                    <a href="#"><span class="flaticon-right-arrow"></span></a>
                                </div><!-- End Single Career -->
